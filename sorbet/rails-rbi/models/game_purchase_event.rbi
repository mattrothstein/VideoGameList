...
class GamePurchaseEvent < ApplicationRecord
  ...
  def after_add_for_game_purchase; end

  sig { returns(T.untyped) }
  def after_add_for_game_purchase?; end

  sig { params(val: T.untyped).returns(T.untyped) }
  def after_add_for_game_purchase=(val); end

  sig { returns(T.untyped) }
  def after_remove_for_game_purchase; end

  sig { returns(T.untyped) }
  def after_remove_for_game_purchase?; end

  sig { params(val: T.untyped).returns(T.untyped) }
  def after_remove_for_game_purchase=(val); end

  sig { returns(T.untyped) }
  def before_add_for_game_purchase; end

  sig { returns(T.untyped) }
  def before_add_for_game_purchase?; end

  sig { params(val: T.untyped).returns(T.untyped) }
  def before_add_for_game_purchase=(val); end

  sig { returns(T.untyped) }
  def before_remove_for_game_purchase; end

  sig { returns(T.untyped) }
  def before_remove_for_game_purchase?; end

  sig { params(val: T.untyped).returns(T.untyped) }
  def before_remove_for_game_purchase=(val); end
...
module GamePurchaseEvent::GeneratedAttributeMethods
  ...
  sig { params(args: T.untyped).returns(T.untyped) }
  def saved_change_to_event_type?(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def saved_change_to_event_type(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_before_last_save(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def will_save_change_to_event_type?(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_change_to_be_saved(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_in_database(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_changed?(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_change(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_will_change!(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_was(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_previously_changed?(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_previous_change(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def restore_event_type!(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_before_type_cast(*args); end

  sig { params(args: T.untyped).returns(T.untyped) }
  def event_type_came_from_user?(*args); end
